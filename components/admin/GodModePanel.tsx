...
export function GodModePanel({ members, onReveal, onReset }: GodModePanelProps) {
  ...
  return (
    <div className="w-full rounded-2xl border border-gold/40 bg-gold-soft/30 p-4">
      ...
      >
        <span className="grid h-6 w-6 place-items-center rounded-md bg-gold text-[#0e1a33]">⚡</span>
              ...
              {unlit.map((m) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-auto rounded-md bg-gold px-2.5 py-1 font-mono text-[11px] font-bold text-[#0e1a33] transition-colors hover:bg-gold-soft"
                  >
                    ⚡ reveal
                  </button>
                </div>
