...
const variants: Record<Variant, string> = {
  gold: "bg-gold text-[#0e1a33] shadow-[0_16px_34px_-14px_rgba(224,164,54,0.7)] hover:bg-[color-mix(in_srgb,var(--color-gold)_82%,white)]",
  blue: "bg-verve text-white shadow-[0_16px_34px_-14px_rgba(47,107,255,0.6)] hover:bg-verve-glow",
  ghost: "bg-surface text-ink border border-line hover:border-verve hover:text-verve",
};
